...
import ru.denik.utils.UtilsTools;

public class LeadPickaxeBig extends UtilsTools {

	public LeadPickaxeBig(ToolMaterial material) {
		super(material);
		setCreativeTab(MainClass.tabMod);
		
	}
    private static Material[] materials = {Material.ground, Material.anvil, Material.glass, Material.ice, Material.iron, Material.packedIce, Material.piston, Material.rock};
    private static int mineRadius = 1, mineDepth = 1;
